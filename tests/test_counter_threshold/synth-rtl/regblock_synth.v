...
module regblock(clk, rst, s_apb_psel, s_apb_pwrite, s_apb_penable, s_apb_pprot, s_apb_paddr, s_apb_pwdata, s_apb_pstrb, s_apb_pready, s_apb_prdata, s_apb_pslverr, hwif_out_threshold_via_bool_count, hwif_out_threshold_via_bool_count_incrthreshold, hwif_out_threshold_via_bool_count_decrthreshold, hwif_in_threshold_via_bool_count_incr, hwif_in_threshold_via_bool_count_decr, hwif_out_threshold_via_const_count, hwif_out_threshold_via_const_count_incrthreshold, hwif_out_threshold_via_const_count_decrthreshold, hwif_in_threshold_via_const_count_incr
, hwif_in_threshold_via_const_count_decr, hwif_out_threshold_via_ref_count, hwif_out_threshold_via_ref_count_incrthreshold, hwif_out_threshold_via_ref_count_decrthreshold, hwif_in_threshold_via_ref_count_incr, hwif_in_threshold_via_ref_count_decr);
  input clk;
  wire clk;
  input rst;
  wire rst;
  ...
  assign _009_[1] = field_storage_threshold_via_bool_count_value[3] & field_storage_threshold_via_bool_count_value[2];
  ...
  assign _086_ = _012_[1] & field_storage_threshold_via_const_count_value[1];
  ...
  assign _011_[0] = _053_[0] & _053_[1];
  assign _011_[1] = _053_[2] & _053_[3];
  assign _057_ = _011_[0] & _011_[1];
  assign hwif_out_threshold_via_const_count_incrthreshold = _048_ | _049_;
  assign _012_[0] = _039_[0] & field_storage_threshold_via_const_count_value[1];
  assign _012_[1] = _045_[2] & field_storage_threshold_via_const_count_value[3];
  assign _049_ = _012_[0] & _012_[1];
  assign hwif_out_threshold_via_bool_count_decrthreshold = _061_ | _062_;
  assign _013_[0] = _036_[0] & _060_[1];
  assign _013_[1] = _060_[2] & _060_[3];
  assign _062_ = _013_[0] & _013_[1];
