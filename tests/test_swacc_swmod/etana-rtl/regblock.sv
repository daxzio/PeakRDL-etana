...
module regblock (
    ...
    // Field logic
    //--------------------------------------------------------------------------
    assign hwif_out_r1_f_swmod = 1'b0;
    ...
    assign hwif_out_r2_f_swmod = decoded_reg_strb_r2 && decoded_req_is_wr && (|(decoded_wr_biten[7:0]));
    // always_comb begin
    always @(*) begin
        logic [7:0] next_c;
        logic load_next_c;
        ...
        load_next_c = '0;
        if(decoded_reg_strb_r3 && !decoded_req_is_wr) begin // SW clear on read
            next_c = '0;
            load_next_c = '1;
        end else if(decoded_reg_strb_r3 && decoded_req_is_wr) begin // SW write
    ...
    assign hwif_out_r3_f_swmod = (decoded_reg_strb_r3 && !decoded_req_is_wr) || (decoded_reg_strb_r3 && decoded_req_is_wr && (|(decoded_wr_biten[7:0])));
    // always_comb begin
    always @(*) begin
        logic [7:0] next_c;
        logic load_next_c;
    ...
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage_r4_f_value <= 8'h12;
    ...
    assign hwif_out_r4_f_swmod = decoded_reg_strb_r4 && decoded_req_is_wr && (|(decoded_wr_biten[7:0]));
    ...
    always @(*) begin
        ...
        load_next_c = '0;
        if(decoded_reg_strb_r5 && !decoded_req_is_wr) begin // SW clear on read
            next_c = '0;
            load_next_c = '1;
    ...
    always_ff @(posedge clk) begin
        if(rst) begin
            field_storage_r5_f_value <= 8'h1e;
    ...
    assign hwif_out_r5_f_swmod = decoded_reg_strb_r5 && !decoded_req_is_wr;
...
//--------------------------------------------------------------------------
    ...
    assign readback_array[0][7:0] = (decoded_reg_strb_r1 && !decoded_req_is_wr) ? hwif_in_r1_f : '0;
