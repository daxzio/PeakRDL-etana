...
module regblock (
        ...
        output logic [0:0] hwif_out_saturate_via_bool_intr,
        output logic [7:0] hwif_out_saturate_via_bool_count,
        output logic [0:0] hwif_out_saturate_via_bool_count_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_count_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_increment,
        output logic [0:0] hwif_out_saturate_via_bool_increment_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_increment_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_decrement,
        output logic [0:0] hwif_out_saturate_via_bool_decrement_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_decrement_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_clear,
        output logic [0:0] hwif_out_saturate_via_bool_clear_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_clear_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_set,
        output logic [0:0] hwif_out_saturate_via_bool_set_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_bool_set_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_intr,
        output logic [7:0] hwif_out_saturate_via_const_count,
        output logic [0:0] hwif_out_saturate_via_const_count_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_count_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_increment,
        output logic [0:0] hwif_out_saturate_via_const_increment_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_increment_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_decrement,
        output logic [0:0] hwif_out_saturate_via_const_decrement_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_decrement_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_clear,
        output logic [0:0] hwif_out_saturate_via_const_clear_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_clear_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_set,
        output logic [0:0] hwif_out_saturate_via_const_set_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_const_set_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_intr,
        output logic [7:0] hwif_out_saturate_via_ref_count,
        output logic [0:0] hwif_out_saturate_via_ref_count_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_count_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_increment,
        output logic [0:0] hwif_out_saturate_via_ref_increment_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_increment_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_decrement,
        output logic [0:0] hwif_out_saturate_via_ref_decrement_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_decrement_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_clear,
        output logic [0:0] hwif_out_saturate_via_ref_clear_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_clear_decrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_set,
        output logic [0:0] hwif_out_saturate_via_ref_set_incrthreshold,
        output logic [0:0] hwif_out_saturate_via_ref_set_decrthreshold,
        output logic [0:0] hwif_out_saturate_control_intr
    );
