...
module regblock(clk, rst, s_apb_psel, s_apb_pwrite, s_apb_penable, s_apb_pprot, s_apb_paddr, s_apb_pwdata, s_apb_pstrb, s_apb_pready, s_apb_prdata, s_apb_pslverr, hwif_out_r1_intr, hwif_out_r1_f, hwif_out_r1_f_anded, hwif_out_r1_f_ored, hwif_out_r1_f_xored, hwif_out_r1_f_incrthreshold, hwif_out_r1_f_decrthreshold);
  input clk;
  wire clk;
  input rst;
  wire rst;
