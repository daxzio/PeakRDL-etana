...
module regblock (
        ...
        output logic [0:0] hwif_out_r1_f_anded,
        output logic [0:0] hwif_out_r1_f_ored,
        output logic [0:0] hwif_out_r1_f_xored
    );
    ...
    assign hwif_out_r1_f_anded = &(field_storage_r1_f_value);
    assign hwif_out_r1_f_ored = |(field_storage_r1_f_value);
    assign hwif_out_r1_f_xored = ^(field_storage_r1_f_value);
