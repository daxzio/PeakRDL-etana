...
module regblock_wrapper (
        ...
        output logic hwif_out_r1_f_anded,
        output logic hwif_out_r1_f_ored,
        output logic hwif_out_r1_f_xored
    );
    ...
    assign hwif_out_r1_f_anded = hwif_out.r1.f.anded;
    assign hwif_out_r1_f_ored = hwif_out.r1.f.ored;
    assign hwif_out_r1_f_xored = hwif_out.r1.f.xored;
