...
module regblock(clk, rst, s_apb_psel, s_apb_pwrite, s_apb_penable, s_apb_pprot, s_apb_paddr, s_apb_pwdata, s_apb_pstrb, s_apb_pready, s_apb_prdata, s_apb_pslverr, hwif_out_r1_intr, hwif_in_r1_f_sw, hwif_out_r1_f_sw_incrthreshold, hwif_out_r1_f_sw_decrthreshold, hwif_in_r1_f_sw_we, hwif_in_r1_f_hw, hwif_out_r1_f_hw_incrthreshold, hwif_out_r1_f_hw_decrthreshold, hwif_in_r1_f_hw_we
, hwif_out_r1_events_intr);
  input clk;
  wire clk;
  input rst;
  wire rst;
  ...
  output [0:0] hwif_out_r1_f_sw_incrthreshold;
  wire [0:0] hwif_out_r1_f_sw_incrthreshold;
  output [0:0] hwif_out_r1_f_sw_decrthreshold;
  wire [0:0] hwif_out_r1_f_sw_decrthreshold;
  input [0:0] hwif_in_r1_f_sw_we;
  wire [0:0] hwif_in_r1_f_sw_we;
  input [0:0] hwif_in_r1_f_hw;
  wire [0:0] hwif_in_r1_f_hw;
  output [0:0] hwif_out_r1_f_hw_incrthreshold;
  wire [0:0] hwif_out_r1_f_hw_incrthreshold;
  output [0:0] hwif_out_r1_f_hw_decrthreshold;
  wire [0:0] hwif_out_r1_f_hw_decrthreshold;
  input [0:0] hwif_in_r1_f_hw_we;
  wire [0:0] hwif_in_r1_f_hw_we;
  output [0:0] hwif_out_r1_events_intr;
  wire [0:0] hwif_out_r1_events_intr;
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  reg \cpuif_wr_biten_reg[2] ;
  always @(posedge clk)
    if (rst) \cpuif_wr_biten_reg[2]  <= 1'h0;
    else if (_009_) \cpuif_wr_biten_reg[2]  <= s_apb_pstrb[0];
  assign cpuif_wr_biten[2] = \cpuif_wr_biten_reg[2] ;
  ...
  assign _004_ = cpuif_wr_data[0] & cpuif_wr_biten[2];
  assign _019_ = _003_ | _004_;
  assign _005_ = field_storage_r1_f_hw_value & _018_;
  assign _006_ = cpuif_wr_data[1] & cpuif_wr_biten[2];
  ...
  assign { cpuif_wr_biten[7:3], cpuif_wr_biten[1:0] } = { cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2] };
  assign cpuif_wr_err = 1'h0;
  assign decoded_req = cpuif_req;
  assign decoded_req_is_wr = cpuif_req_is_wr;
  assign decoded_wr_biten = { cpuif_wr_biten[31:8], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2], cpuif_wr_biten[2] };
