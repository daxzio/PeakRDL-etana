...
module regblock(clk, rst, s_cpuif_req, s_cpuif_req_is_wr, s_cpuif_addr, s_cpuif_wr_data, s_cpuif_wr_biten, s_cpuif_req_stall_wr, s_cpuif_req_stall_rd, s_cpuif_rd_ack, s_cpuif_rd_err, s_cpuif_rd_data, s_cpuif_wr_ack, s_cpuif_wr_err, hwif_out_r1_intr, hwif_out_r2_intr, hwif_out_r3_intr, hwif_out_r4_intr);
  input clk;
  wire clk;
  input rst;
  wire rst;
