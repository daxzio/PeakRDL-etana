...
module regblock (
        ...
        output logic [0:0] hwif_out_r1_f_rd_swacc,
        output logic [7:0] hwif_out_r2_f,
        output logic [0:0] hwif_out_r2_f_wr_swacc
    );
    ...
    // Field logic
    //--------------------------------------------------------------------------
    assign hwif_out_r1_f_rd_swacc = decoded_reg_strb_r1 && !decoded_req_is_wr;
    // always_comb begin
    always @(*) begin
        logic [7:0] next_c;
        logic load_next_c;
    ...
    assign hwif_out_r2_f_wr_swacc = decoded_reg_strb_r2 && decoded_req_is_wr;
