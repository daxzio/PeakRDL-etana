...
class AHB5MonitorDX(AHBMonitor):
    def __init__(
...
class AHB5MasterDX(AHBLiteMaster):
    def __init__(
        self,
        bus: AHBBus,
        clock: str,
    ...
    def prepare_addresses(
        ...
        if length is None:
            ...
            self.length = length
        if not __import__("math").log2(self.length).is_integer():
    ...
    async def read(
        ...
        **kwargs,
        ...
        ret = await super().custom(
            self.addresses, self.mode, mode=self.mode, exclusive=exclusive, **kwargs
        )
    ...
    async def read_excl(
        ...
        **kwargs,
        ...
        return await self.read(address, value=value, exclusive=True, **kwargs)
    ...
    async def write_excl(
        ...
        **kwargs,
        ...
        return await self.write(address, value, exclusive=True, **kwargs)
