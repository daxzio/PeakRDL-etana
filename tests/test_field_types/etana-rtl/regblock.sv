...
module regblock (
        ...
        output logic [0:0] hwif_out_r7_intr,
        input wire [7:0] hwif_in_r7_f,
        output logic [0:0] hwif_out_r7_f_incrthreshold,
        output logic [0:0] hwif_out_r7_f_decrthreshold,
        output logic [0:0] hwif_out_r8_intr,
        output logic [0:0] hwif_out_r9_intr,
        input wire [7:0] hwif_in_r9_f,
        output logic [7:0] hwif_out_r9_f,
        output logic [0:0] hwif_out_r9_f_incrthreshold,
        output logic [0:0] hwif_out_r9_f_decrthreshold,
        input wire [0:0] hwif_in_r9_f_we,
        output logic [0:0] hwif_out_r10_intr,
        output logic [7:0] hwif_out_r10_f,
        output logic [0:0] hwif_out_r10_f_incrthreshold,
        output logic [0:0] hwif_out_r10_f_decrthreshold
    );
