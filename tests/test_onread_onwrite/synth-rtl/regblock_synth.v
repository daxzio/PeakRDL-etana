...
module regblock(clk, rst, s_apb_psel, s_apb_pwrite, s_apb_penable, s_apb_pprot, s_apb_paddr, s_apb_pwdata, s_apb_pstrb, s_apb_pready, s_apb_prdata, s_apb_pslverr, hwif_out_r1_intr, hwif_out_r2_intr, hwif_out_r3_intr, hwif_out_r4_intr);
  input clk;
  wire clk;
  input rst;
  wire rst;
  ...
  reg \field_storage_r4_f1_value_reg[6] ;
  always @(posedge clk)
    if (rst) \field_storage_r4_f1_value_reg[6]  <= 1'h1;
    else if (field_combo_r4_f1_load_next) \field_storage_r4_f1_value_reg[6]  <= 1'h0;
  assign field_storage_r4_f1_value[6] = \field_storage_r4_f1_value_reg[6] ;
  always @(posedge clk)
  ...
  reg \field_storage_r4_f2_value_reg[5] ;
  always @(posedge clk)
    if (rst) \field_storage_r4_f2_value_reg[5]  <= 1'h0;
    else if (field_combo_r4_f1_load_next) \field_storage_r4_f2_value_reg[5]  <= 1'h1;
  assign field_storage_r4_f2_value[5] = \field_storage_r4_f2_value_reg[5] ;
  always @(posedge clk)
  ...
  assign \readback_array[3] [7] = \readback_array[3] [11] ? field_storage_r4_f1_value[6] : 1'h0;
  assign \readback_array[3] [15] = \readback_array[3] [11] ? field_storage_r4_f2_value[5] : 1'h0;
  ...
  assign { field_storage_r4_f1_value[7], field_storage_r4_f1_value[5:0] } = { field_storage_r4_f1_value[6], field_storage_r4_f1_value[6], field_storage_r4_f1_value[6], 4'h0 };
  assign { field_storage_r4_f2_value[7:6], field_storage_r4_f2_value[4:0] } = { field_storage_r4_f2_value[5], field_storage_r4_f2_value[5], field_storage_r4_f2_value[5], 4'hf };
